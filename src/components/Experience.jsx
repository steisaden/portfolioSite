...
const ExperienceCard = ({ experience }) => (
  <VerticalTimelineElement
    contentStyle={{ background: 'rgb(77 78 80 / 85%)', color: '#fff' }}
...
const Experience = () => {
  return (
    <>
      ...
      >
        <p className={styles.sectionSubText2}>Some Recent Stuff...</p>
        <h2 className={`${styles.sectionHeadText} text-[#b96d79]`}>Work Experience.</h2>
      </motion.div>
