...
// service_1mob2tr
// 0tmOQ8__QxjMZqPD8
// 90eQtln0lEwwW7aryPV9m private key
...
const Contact = () => {
  ...
  return (
    <div
      className={`bg-transparent xl:mt-12 flex xl:flex-row flex-col-reverse gap-10 overflow-hidden`}
    >
      <motion.div
        variants={slideIn("left", "tween", 0.2, 1)}
        className='flex-[0.75] bg-transparent p-8 rounded-2xl'
      >
        <p className={`${styles.sectionSubText2} text-primary`}>Get in touch</p>
        ...
        >
          <label className='flex flex-col'>
            ...
            <input
              ...
              className='bg-black-300 py-4 px-6 placeholder:text-primary text-white rounded-lg outline-none border-none font-medium'
            />
          </label>
          <label className='flex flex-col'>
